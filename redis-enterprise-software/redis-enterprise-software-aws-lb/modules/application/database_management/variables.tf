...
variable "cluster_fqdn" {
  description = "Cluster FQDN name for database endpoint creation"
  type        = string
}
...
variable "load_balancer_config_id" {
  description = "Load balancer configuration resource ID to ensure proper ordering"
  type        = string
}
