...
resource "null_resource" "sample_database" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "curl -k -L -u '${var.cluster_username}:'$(cat /tmp/cluster_pass.txt) -H 'Content-type:application/json' -d '{\"name\":\"${var.sample_db_name}\",\"type\":\"redis\",\"memory_size\":${var.sample_db_memory * 1048576},\"port\":${var.sample_db_port},\"replication\":false}' https://localhost:9443/v1/bdbs",
